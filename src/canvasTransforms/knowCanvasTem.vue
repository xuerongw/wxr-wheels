<template>
  <div class="knowCanvas">
    <canvas ref="canvas" width="1000px" height="937px"> </canvas>
    <img src="@/assets/towbg.jpeg" alt="" id="img" style="display: none" />
  </div>
</template>
...
export default {
  methods: {
    text() {
      ...
      ctx.strokeText("文字", 20, 20); //没有填色的文字，
